        ...
        <div className="w-full px-4 xl:px-6 flex items-center justify-between h-14 gap-4">
          ...
          <div className="flex items-center gap-3 z-10 shrink-0">
            <Link to="/" className="flex items-center gap-2 md:gap-3 font-heading font-semibold text-lg md:text-xl tracking-tighter text-gray-900 uppercase leading-[0.85]">
              <img src="/cropped-Save-My-LA-logo.png" alt="Logo" className="w-10 h-10 md:w-16 md:h-16 object-contain" />
          ...
          <nav className="hidden xl:flex flex-1 justify-center items-center gap-6 2xl:gap-10 whitespace-nowrap">
            ...
            <Link to="/news" className="text-[11px] 2xl:text-[12px] font-bold tracking-widest uppercase text-brand-red hover:text-red-700 transition-colors relative group py-1 whitespace-nowrap">News & Updates</Link>
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-8 flex flex-col gap-8">
            <nav className="flex flex-col gap-6">
              ...
              <Link to="/news" onClick={() => setMenuOpen(false)} className="text-2xl font-heading font-light text-brand-red hover:text-red-700 transition-colors">News & Updates</Link>
