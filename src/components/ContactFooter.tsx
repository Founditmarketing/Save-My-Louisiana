...
import { Facebook, Mail, MapPin, Phone, Instagram, ArrowRight, Youtube } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
                    ...
                    <div className="space-y-4">
                        <Link to="/" className="inline-block">
                            <img src="/cropped-Save-My-LA-logo.png" alt="Save My Louisiana" className="h-16 w-auto object-contain opacity-90 hover:opacity-100 transition-opacity" />
                        </Link>
                        ...
                        <div className="flex gap-4 pt-2">
                            ...
                            <a href="https://www.instagram.com/savemylouisiana" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" title="Instagram"><Instagram size={20} /></a>
                            <a href="https://www.youtube.com/@savemylouisiana" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" title="YouTube"><Youtube size={20} /></a>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-gray-300">
                            ...
                            <li><Link to="/environmental-dangers" className="hover:text-white transition-colors">Environmental & Economic Dangers</Link></li>
