      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 flex flex-col items-center text-center">
          ...
          <div className={`grid md:grid-cols-2 gap-6 w-full transition-all duration-1000 delay-300 ${hasEntered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            {/* Option 1: Donate */}
            <Link to="/donate" className="group relative bg-white/5 border border-white/10 hover:bg-brand-red hover:border-brand-red rounded-[2rem] p-10 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col items-center justify-center text-center">
