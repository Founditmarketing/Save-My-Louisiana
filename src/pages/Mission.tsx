                    ...
                    <div className="grid md:grid-cols-2 gap-8 pt-8">
                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 space-y-4">
                            <h3 className="text-xl font-bold font-heading flex items-center gap-2">
                                <Shield className="text-brand-blue" /> Constitutional Commitment
                            </h3>
                            <p className="text-gray-600 font-serif leading-relaxed">
                                SML is strongly committed to the constitutionally guaranteed rights of Louisiana citizens to Life, Liberty and Property. We believe the Louisiana Constitution is the supreme law of Louisiana subject only to the Constitution of the United States. No one citizen’s natural rights can be subverted by another citizen or any industry.
                            </p>
                        </div>
                        <div className="p-8 bg-brand-blue/5 rounded-3xl border border-brand-blue/10 space-y-4">
                            <h3 className="text-xl font-bold font-heading flex items-center gap-2">
                                <Scale className="text-brand-blue" /> Equal Before the Law
                            </h3>
                            <p className="text-gray-600 font-serif leading-relaxed">
                                We believe these two Constitutions by intention and in fact, guarantee that we are all, citizen and industry, equal before the law. SML is PRO-economic development, PRO-oil and gas, and PRO-industry. BUT, SML is ANTI any action that would use the power and force of law to undermine basic rights.
                            </p>
                        </div>
                    </div>

                    <p className="text-lg text-gray-700 font-serif leading-relaxed italic border-l-4 border-brand-red pl-8">
                        "We strongly believe that citizen’s constitutionally protected rights can coexist in harmony under the law with both economic development and robust industry."
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 pt-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-gray-300 font-serif leading-relaxed">
                                SML’s additional though equal mission is to educate and empower the citizens of Louisiana to understand, protect and defend our life giving and sustaining environment. We are dedicated to ensuring our fellow citizens are aware of potential environmental dangers and informed on how to take action. We will challenge and defeat any activities by the state or private industry that would place our environment in danger.
                            </p>
                        </div>
                    </div>
                </div>
