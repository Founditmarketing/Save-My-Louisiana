            ...
            <section className="py-20 px-6 bg-gray-50 overflow-hidden">
                <div className="max-w-4xl mx-auto space-y-12">
                    <div className="space-y-6">
                        ...
                        <p className="text-lg text-gray-700 font-serif leading-relaxed">
                            Of the three foundational Rights our government was formed to protect, Property is among them. The ownership and control of Property is essential to true independence, and independence is essential to one’s Life and Liberty. Our Property is the best guarantor of our freedom and it represents our generational wealth. Learn more about the <Link to="/property-rights" className="text-brand-blue hover:underline font-bold italic">Purpose of Government</Link>.
                        </p>
                    </div>
